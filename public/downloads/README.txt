...
- taekbyeong-fmm-companions-ui-1.20.1-v11.zip
  현재 Forge 1.20.1 필수 통합 리소스팩. FMM 동료 12종·ItemDisplay 대체, 본문 위에 겹치는 가변 표제판, 단일 클릭 밀랍 인장, TAB 사이드바 UI를 포함합니다.

- taekbyeong-fmm-companions-ui-1.20.1-v10.zip
  표제판 겹침·인장 클릭 보정 전 이전 팩입니다.

- taekbyeong-fmm-companions-ui-1.20.1-v9.zip
  모듈형 두루마리 전환 전 FMM 이전 팩입니다.
...
- taekbyeong-modelengine-ui-1.20.1-v2.zip
  사용 중지된 ModelEngine 무료판 이전 팩입니다.

- taekbyeong-modelengine-ui-1.20.1-v3.zip
  기본 폰트 호환성 문제로 사용 중지된 시험판입니다.

- taekbyeong-modelengine-ui-1.20.1-v4.zip
  CDN 캐시 보호를 위해 사용 중지한 이전 v4 주소입니다.

- taekbyeong-modelengine-ui-1.20.1-v4-atlas-safe.zip
...
- taekbyeong-ui-1.20.1-v1.zip
  이전 UI 전용 리소스팩. 서버 접속용으로는 통합 v11을 사용합니다.

- taekbyeong-modelengine-free-pets-v1.zip
  사용 중지한 이전 ModelEngine blueprints 4종입니다.

서드파티 플러그인·모드 JAR, 월드, DB, 플레이어 데이터는 포함하지 않습니다.

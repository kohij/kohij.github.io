...
export const pets: Pet[] = [
  ...
  {
    name: "404 복어",
    model: "BetterModel / Pufferfish 폴백",
    role: "낚시 명예 · 404 잠수",
    unlock: "1,600,000원",
  ...
  {
    name: "벌꿀 슬라임",
    model: "BetterModel / Small Slime 폴백",
    role: "농업·양조 · 달콤한 대사",
    unlock: "950,000원",
  ...
  {
    name: "특이점 감시자",
    model: "BetterModel / Endermite 폴백",
    role: "특이점 명예 · 혼돈 순환",
    unlock: "5,000,000원",
